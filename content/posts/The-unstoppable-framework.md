...
Examples:
- Goal: Learn computer programming
  Action: Code 25 functional programs
- Goal: Get into a relationship
  Action: Have 100 interesting conversations with strangers
- Goal: Become a famous YouTuber
  Action: Make 100 videos packed with value
